...
export const galleryImages: GalleryImage[] = [
  ...
  },
  {
    ...
    caption: "Explaining the build · AI Mini Hackathon",
    description:
      "Dr Swapnil Sahoo speaks during the 5 July final. Camera-original event photograph; photographer not identified.",
    objectPosition: "54% center",
  },
  {
    src: "/images/ai-hackathon/hackathon-room.jpg",
    alt: "Dr Swapnil Sahoo presenting to the AI Mini Hackathon jury and participants",
    caption: "Inside the final room · AI Mini Hackathon",
    description:
      "A live teaching moment during the 5 July final. Camera-original event photograph; photographer not identified.",
