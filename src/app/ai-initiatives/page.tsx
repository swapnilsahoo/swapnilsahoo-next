...
const description =
  "The two ways I work on AI at Great Lakes Gurgaon: a hands-on AI-literacy workshop for teachers and academic staff, and the AI Mini Hackathon — a build-first GenAI programme for PGDM students.";
  ...
  return (
    <main id="main-content" tabIndex={-1}>
        ...
        <Container className="max-w-[87.5rem]">
          ...
          >
            ...
            <p className="mt-6 max-w-3xl text-base leading-relaxed text-blue-100 sm:text-lg">
              ...
              side, that splits into two efforts with two different audiences — a literacy
              workshop for the teachers who plan lessons and grade work, and a build-first
              programme for the students who have to ship something a real person can open and
              question. Both return to the same rule: AI drafts, a person reviews, edits and owns
              it.
            </p>
      ...
      <InquiryPrelude
        ...
        eyebrow="Worth asking before either one starts"
        ...
        questions={[
          ...
          "For a student team: would your prototype still work if the person testing it tried to break it on purpose?",
        ]}
      />
      ...
      <section id="directory" aria-labelledby="directory-title" className="pb-20 sm:pb-28">
        <Container className="max-w-[87.5rem]">
          <div className="mb-10 max-w-3xl">
            ...
            <p className="eyebrow mb-3">Both programmes</p>
