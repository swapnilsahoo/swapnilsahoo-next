  ...
  return (
    <main id="main-content" tabIndex={-1}>
      ...
      <InquiryPrelude
        ...
        questions={hackathonInquiry.questions}
      />
          ...
          <div className="from-brand-50 to-accent-400/10 dark:from-brand-900/30 dark:to-accent-400/5 border-brand-200/60 dark:border-brand-700/40 relative overflow-hidden rounded-[24px] border bg-gradient-to-br p-7 sm:p-10">
            ...
            <div className="relative grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
              <div>
                ...
                <h2 id="side-quests-title" className="display text-3xl font-semibold sm:text-4xl">
                  This hackathon didn&apos;t stop when the event ended.
                </h2>
                <p className="text-ink-700 dark:text-ink-200 mt-4 max-w-2xl text-sm leading-relaxed sm:text-base">
                  I kept building. Side Quests is where those personal, off-syllabus prototypes
                  live — starting with{" "}
                  <strong className="text-ink-800 dark:text-ink-100 font-semibold">
                    AI Viva Bot
                  </strong>
                  , a live oral-exam simulator that needs people willing to try to break it.
                </p>
              </div>
              <Link
