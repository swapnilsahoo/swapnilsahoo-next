        ...
        groups: [
          {
            ...
            files: [
              {
                label: "Round 6 comprehensive debrief (both sections, all 4 universes, R1→R6 life journeys, cross-cohort synthesis)",
                format: "Slides",
                href: "/documents/business-simulation/round-6/round6-comprehensive-debrief.pptx",
              },
              {
                label: "Universe 1 results workbook",
                format: "Workbook",
